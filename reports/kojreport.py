...
from conf.kojoney_config import DATABASE_FILE

if DATABASE_FILE[0] != '/':
  # Adjust for relative file location
  DATABASE_FILE = '../' + DATABASE_FILE
import urllib
import socket
from lib.nmapparser import NmapParser

# Class Report - actual script is down below
class Report:
  def __init__(self):
    try:
...
if __name__ == "__main__":
  ...
  print
  print 'Number of distinct IP\'s opening a shell:'
  print '------------------------------------------'
      ...
      if commands is not False:
        for cmds in commands:
          ...
          if x == 1:
            ...
            if not (creds is False or creds is None):
